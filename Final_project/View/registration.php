...
<html>  
      ...
      <body>  
           ...
           <div class="container" style="width:500px;">  
                ...
                <form name="myform" action="../controller/registerUser.php" method="post" onsubmit="return validateform()">  
                     <?php   
                     if(isset($error))  
                     {  
                          echo $error;  
                     ...
                     <input type="text" name = "username" id="un" class="form-control" onblur="checkUserName()" onkeyup="checkUserName()"/><span style="color:red" id="unErr"></span><br />
