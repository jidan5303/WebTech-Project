...
<body style=" margin:0;">
    ...
    <div class = "dashboard">
        ...
        <nav>
            ...
            <a style="text-decoration: none;" href="admindashboard.php">Exit Personal Dashboard</a>
        </nav>
    </div>
        ...
        <h1><div style="display:flex; justify-content: center; align-items: center;"><span style="color:blue;">Profile Dashboard of</span></div></h1>
