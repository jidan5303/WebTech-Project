...
<body style=" margin:0;">
    ...
    <div class = "dashboard">
        ...
        <nav>
            ...
            <a style="text-decoration: none;" href="restaurantOwner.php">Restaurant Owner Details</a>
            <a style="text-decoration: none;" href="deliveryboy.php">Delivery Boy Details</a>
            <a style="text-decoration: none;" href="reportDetail.php">Reports</a>
            <a style="text-decoration: none;" href="welcomeDashboard.php">Personal Details</a>
        </nav>
    </div>
